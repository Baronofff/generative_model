...
def create_mini_version(input_file, output_file, max_size_mb=5):
    ...
    :param max_size_mb: максимальный размер нового файла в МБ (по
        умолчанию 5MB)
    """
...
if __name__ == "__main__":
    input_file = r"C:\Users\user\programming_projects\generative_model\texts\collect.txt"  # Ваш исходный большой файл
    output_file = r"C:\Users\user\programming_projects\generative_model\texts\collect_mini.txt"  # Уменьшенная версия

    # Создаем уменьшенную версию (5MB)
    create_mini_version(input_file, output_file, max_size_mb=2)
